      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="hidden md:block absolute left-1/2 top-0 w-0.5 h-full bg-gray-200 -translate-x-1/2" />
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="group relative bg-white border border-gray-200 rounded-3xl p-8 hover:border-cyan-400/40 hover:shadow-2xl hover:shadow-cyan-100 transition duration-500 overflow-hidden">
                        {/* Hover Glow */}
                        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-linear-to-br from-cyan-100/40 to-blue-100/40" />
